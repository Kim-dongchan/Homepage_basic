    ...
    <ul>
 	<?php
 	  ...
 	  <?php }
         ...
         <li><a href="logout.php" onclick="tel()">로그아웃</a></li>
  ...
  <section>
    <div>
      ...
      <div class="mySlides fade">
        ...
        <img src="img2/coffee11.jpg" style="width:100%; height:400px;">
        <div class="text">Caption Text</div>
      </div>

      <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="img2/coffee22.jpg" style="width:100%; height:400px;">
        <div class="text">Caption Two</div>
      </div>

      <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="img2/coffee33.jpg" style="width:100%; height:400px;">
    ...
    <form action="" method="post" >
      <table>
       ...
       <p align="center"><input type="submit" value="보내기" onclick="query()">&nbsp;&nbsp;&nbsp;<input type="reset" value="취소"></p>
  </form>
